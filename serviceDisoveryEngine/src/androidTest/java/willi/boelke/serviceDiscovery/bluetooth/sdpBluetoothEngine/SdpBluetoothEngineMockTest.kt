...
import willi.boelke.serviceDiscovery.testUtils.*
...
class SdpBluetoothEngineMockTest {
    ...
    fun setup() {
        ...
        //Run
        SdpBluetoothEngine.getInstance().start(mockedContext, mockedBtAdapter)
    ...
    @After
    fun teardown() {
        SdpBluetoothEngine.getInstance().callPrivateFunc("teardownEngine")
