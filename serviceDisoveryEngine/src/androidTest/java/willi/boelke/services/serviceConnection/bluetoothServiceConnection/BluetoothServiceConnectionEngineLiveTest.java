...
public class BluetoothServiceConnectionEngineLiveTest
{
    ...
    public void itShouldEstablishOnlyOneConnectionOverOneService_test() throws InterruptedException
    {
        ...
        BluetoothServiceConnectionEngine.getInstance().startSDPService(descriptionForServiceOne, connection -> establishedConnections.add(connection.getServiceDescription()));
    ...
    ////
    ////------------  repeat SdpBluetoothDiscoveryEngine test , but wrapped inside the BluetoothServiceConnectionEngine ---------------
    ////
