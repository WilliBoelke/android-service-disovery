package willi.boelke.serviceDiscovery.wifiDirect.sdpWifiEngine.bluetooth;
...
{
    private SdpBluetoothConnection testConnectionOne;
    private SdpBluetoothConnection testConnectionTwo;
